...
<h4><?= Yii::t('app/email', 'New email requested for account'); ?></h4>

<p><?= Yii::t('app/email', 'Go to reset email link'); ?> <a href="<?= Url::to(BaseUrl::home(true).'profile/recover-email?hash=' . $user->new_email_key); ?>"><?= Yii::t('app/email', 'address link'); ?></a>.</p>
